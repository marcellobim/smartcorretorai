...
const IMAGES_DIR = path.join(REPO_ROOT, 'assets-imoveis', 'alto-padrao-01')
...
const SLIDES_JSON = path.join(ROOT, 'v2-alto-legendas', 'slides.json')
const OUTPUT_FILE = path.join(OUTPUT_DIR, 'output-v2-alto-padrao-legendas.mp4')
...
function classifyScene(slide, index) {
  if (slide.scene) return slide.scene
