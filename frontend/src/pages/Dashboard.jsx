...
const productCards = [
  {
    ...
    badge: 'Hero',
    title: '🚀 Hero',
    description: 'Transforme fotos em materiais que chamam atenção.',
    button: 'Começar',
    to: '/hero',
    status: null,
    accent: 'from-slate-950 via-indigo-950 to-gray-900',
    buttonClass: 'bg-white text-gray-950 hover:bg-gray-100',
    benefits: ['Banner Premium', 'Banner Lifestyle', 'Banner Conversão', '2 mini vídeos'],
  },
  {
    id: 'video',
    icon: Video,
    badge: 'Transforme Meu Vídeo',
    title: '🎥 Transforme Meu Vídeo',
    description: 'Você grava. Nós cuidamos do resto.',
    button: 'Começar',
    ...
    benefits: ['Destaques automáticos', 'Legendas profissionais', 'Música adequada', 'CTA para contatos'],
  },
  {
    id: 'campaign',
    icon: Rocket,
    ...
    description: 'Seu departamento de marketing em minutos.',
    button: 'Começar',
    to: '/nova-campanha',
    status: null,
