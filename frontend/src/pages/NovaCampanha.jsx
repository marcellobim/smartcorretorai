...
const FORMAT_GROUPS = [
  {
    ...
    items: [
      { id: '1ae7e1f4-ada4-4b03-a032-737a025b88c6', nome: 'Imovel Detalhes 1x1',             desc: 'Detalhes do imovel em formato quadrado' },
      { id: '4dd468f4-a439-4a31-b6f3-29be17a1d51d', nome: 'Imovel Detalhes 4x5',             desc: 'Detalhes do imovel para feed vertical' },
      { id: '4ba4698c-3b6e-4548-b73d-814d71bc7f66', nome: 'Imovel Detalhes 4x5 Tipo 2',      desc: 'Variacao vertical com detalhes do imovel' },
      { id: '451b3422-f222-414e-b105-44b896f8277e', nome: 'Imovel Detalhes 9x16',            desc: 'Detalhes do imovel para stories' },
      { id: '71aa0276-bc5f-4245-bb37-62a78fa7cf64', nome: 'Imovel Detalhes 16x9',            desc: 'Detalhes do imovel em formato horizontal' },
      { id: '2ecd48d3-146c-467b-8a0d-908152101378', nome: 'Carrossel Triplo 1x1',             desc: 'Carrossel quadrado com tres destaques' },
      { id: '16682dcd-eb89-404c-94dc-bb9f01317bf4', nome: 'Carrossel Triplo 4x5',             desc: 'Carrossel vertical para feed' },
      { id: '5635ee72-d0da-4906-9a84-6e0b5f587196', nome: 'Carrossel Triplo 4x5 Tipo 2',      desc: 'Variacao vertical de carrossel' },
      { id: '21c3ff4b-f632-405f-8ebf-369c1f7d4b10', nome: 'Carrossel Triplo 9x16',            desc: 'Carrossel para stories' },
      { id: 'fa82c49d-39af-46e8-bc31-3649fff10cae', nome: 'Carrossel Triplo 16x9',            desc: 'Carrossel horizontal' },
      { id: '0e8a9ffd-36e3-493a-bf3b-9d83f3b6699d', nome: 'Card Imobiliario Premium 1x1',     desc: 'Card premium quadrado' },
      { id: 'f7df2c44-ea60-4c42-b862-2d335029acad', nome: 'Card Imobiliario Premium 4x5',     desc: 'Card premium para feed vertical' },
      { id: '2b4e6dff-ee96-42f0-97e1-7956bef9dfa9', nome: 'Card Imobiliario Premium 4x5 Tipo 2', desc: 'Variacao vertical de card premium' },
      { id: '755d1a44-acb9-4539-96b4-f1741b1651af', nome: 'Card Imobiliario Premium 9x16',    desc: 'Card premium para stories' },
      { id: '656ff3e1-325a-419c-9914-dfde82f911b6', nome: 'Card Imobiliario Premium 16x9',    desc: 'Card premium horizontal' },
      { id: '7a12a73e-ace7-4ab4-9739-95741b82232a', nome: 'Galeria Imobiliaria 1x1',          desc: 'Galeria quadrada de fotos' },
      { id: '8e399960-3ade-453a-b868-e7059f30c6a9', nome: 'Galeria Imobiliaria 4x5',          desc: 'Galeria vertical para feed' },
      { id: '660ca820-3d7d-4d9f-8c45-3d6da832588b', nome: 'Galeria Imobiliaria 4x5 Tipo 2',   desc: 'Variacao vertical de galeria' },
      { id: '6de8026b-6cd2-4a19-8491-554079827932', nome: 'Galeria Imobiliaria 9x16',         desc: 'Galeria para stories' },
      { id: 'f2f15dab-77c2-429e-9b62-f8d6694399ed', nome: 'Galeria Imobiliaria 16x9',         desc: 'Galeria horizontal' },
      { id: '9c7e271b-a9c2-475a-b742-8f949e788abf', nome: 'Slides Premium 1x1',               desc: 'Slides premium quadrados' },
      { id: '4a7830c5-ff23-446b-8664-2bc8fe86b2c0', nome: 'Slides Premium 4x5',               desc: 'Slides premium para feed' },
      { id: '13008c2d-9e7e-4515-a2ac-649c9ea18409', nome: 'Slides Premium 4x5 Tipo 2',        desc: 'Variacao vertical de slides premium' },
      { id: 'eb6ae228-a08f-4747-a761-e4d4f716019', nome: 'Slides Premium 9x16',               desc: 'Slides premium para stories' },
      { id: '2d79f2a0-1143-422c-bdef-7d02c5bb72e9', nome: 'Slides Premium 16x9',              desc: 'Slides premium horizontais' },
      { id: 'f0a463cc-261f-4b51-ab7e-77fcea67476e', nome: 'Momentos do Imovel 4x5',           desc: 'Momentos do imovel para feed' },
      { id: '3d72b111-76a7-4c7d-a594-1f75f70be2d2', nome: 'Momentos do Imovel 4x5 Tipo 2',    desc: 'Variacao vertical de momentos do imovel' },
      { id: '62d46ee6-6347-4335-af89-2b65f2794882', nome: 'Momentos do Imovel 16x9',          desc: 'Momentos do imovel em formato horizontal' },
      { id: 'a83a2008-8a6a-4a40-8b6f-d87190a1d306', nome: 'Avaliacao do Cliente 4x5',         desc: 'Prova social para feed' },
      { id: 'cfded0ba-1eb9-4396-ab63-b259cb817a1e', nome: 'Avaliacao do Cliente 4x5 Tipo 2',  desc: 'Variacao vertical de prova social' },
      { id: '52a1e65f-ca92-4c6c-af7e-9f0100c886cb', nome: 'Avaliacao do Cliente 9x16',        desc: 'Prova social para stories' },
      { id: 'e8314ba2-cd0f-44e3-afd1-de41083c0846', nome: 'Story Premium 1x1',                desc: 'Story premium em formato quadrado' },
      { id: '5461c940-4309-4c3f-bba1-d90e83e62a9a', nome: 'Story Premium 4x5',                desc: 'Story premium para feed vertical' },
      { id: 'e15d93e5-dbb0-45c9-b475-2d9e2d6a1d0c', nome: 'Story Premium 4x5 Tipo 2',         desc: 'Variacao vertical de story premium' },
      { id: '1de0a863-2376-4336-8a0a-4750c2429cf7', nome: 'Story Premium 9x16',               desc: 'Story premium vertical' },
      { id: 'c9cf1d8c-4f01-4f65-baf8-ca20c56ad76e', nome: 'Story Premium 16x9',               desc: 'Story premium horizontal' },
      { id: '8aab78ac-60cd-4e83-9f4c-51259c4751c6', nome: 'Frase Elegante 1x1',               desc: 'Frase elegante em formato quadrado' },
      { id: '164eef00-abf4-429a-9334-c9e4c1319998', nome: 'Frase Elegante 4x5',               desc: 'Frase elegante para feed vertical' },
      { id: '9a9c663c-0348-462b-a470-c40a86092a81', nome: 'Frase Elegante 4x5 Tipo 2',        desc: 'Variacao vertical de frase elegante' },
      { id: '697a514d-4bab-4062-9c9e-3c208688c0e9', nome: 'Frase Elegante 9x16',              desc: 'Frase elegante para stories' },
      { id: 'e74922ee-5882-4917-9051-9ae2e4021767', nome: 'Frase Elegante 16x9',              desc: 'Frase elegante horizontal' },
      { id: '329b6afb-c749-4bda-a319-38ad42639034', nome: 'Chat Imobiliario 1x1',             desc: 'Chat imobiliario em formato quadrado' },
      { id: '1db7b057-81e0-4db3-af4e-98a7c987cdfa', nome: 'Chat Imobiliario 4x5',             desc: 'Chat imobiliario para feed vertical' },
      { id: '71ae86ec-d08e-4f32-9d61-d7ddcb829f9e', nome: 'Chat Imobiliario 4x5 Tipo 2',      desc: 'Variacao vertical de chat imobiliario' },
      { id: 'f4b5c0e9-80fe-408a-b139-f7db7dfbbc89', nome: 'Chat Imobiliario 9x16',            desc: 'Chat imobiliario para stories' },
      { id: '172938f9-c868-47ef-890b-bf2593b92565', nome: 'Chat Imobiliario 16x9',            desc: 'Chat imobiliario horizontal' },
    ],
  },
  {
    id: 'videos',
    ...
    items: [
      { id: '9962f7dc-6cca-491f-bffe-3184a2314f21', nome: 'Reels Moderno 1x1',        desc: 'Reels moderno em formato quadrado' },
      { id: 'dfdcea18-0f3d-4c84-baa9-463c182644b7', nome: 'Reels Moderno 4x5 Tipo 2', desc: 'Variacao vertical para feed' },
      { id: '7f7f420d-da91-48c6-b701-0f0fb540b1aa', nome: 'Reels Moderno 4x5',        desc: 'Reels moderno para feed vertical' },
      { id: 'a36c300c-6a64-4161-86fb-ee892e7720d2', nome: 'Reels Moderno 16x9',       desc: 'Reels moderno horizontal' },
      { id: 'd8310f54-5c9d-4606-ae6a-dacb8c4455ae', nome: 'Reels Moderno 9x16',       desc: 'Reels moderno para stories' },
      { id: '9ebd1bda-e650-4d88-b8aa-ff555a419082', nome: 'Video Tour 1x1',           desc: 'Tour do imovel em formato quadrado' },
      { id: '89071652-69ab-4edc-897b-9e7985c95f59', nome: 'Video Tour 4x5',           desc: 'Tour do imovel para feed vertical' },
      { id: '9c831fd6-5412-4afe-9e29-dd8c4984e55c', nome: 'Video Tour 4x5 Tipo 2',    desc: 'Variacao vertical de tour do imovel' },
      { id: 'cd6c0ed3-1dde-4fc0-a604-d728e5cbb73b', nome: 'Video Tour 9x16',          desc: 'Tour do imovel para stories e Reels' },
      { id: 'd5171301-84e3-41d2-a6ca-ef3013f360a1', nome: 'Video Tour 16x9',          desc: 'Tour do imovel horizontal' },
    ],
  },
]
