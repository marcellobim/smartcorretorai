...
const TEMPLATES: TemplateMeta[] = [
  { id: '74097a36-5b5d-434a-8db7-4038e4c76f55', nome: '[OFF] SC_Banner_Luxo_01',         categoria: 'banner',   perfil: ['alto_padrao', 'lancamento'],                                  formato: 'banner-quadrado',      family: 'creatomate-stock', variant: 'luxo',       objective: 'lead_generation',    placement: ['instagram_feed', 'facebook_feed', 'portal'], active: false, legacyCategory: 'legacy' },
  { id: 'a637acac-6a7b-42f8-b7d8-e25361eff207', nome: '[OFF] SC_Banner_Popular_01',      categoria: 'banner',   perfil: ['popular_mcmv', 'medio_padrao'],                               formato: 'banner-quadrado',      family: 'creatomate-stock', variant: 'popular',    objective: 'lead_generation',    placement: ['instagram_feed', 'facebook_feed', 'portal'], active: false, legacyCategory: 'legacy' },
  ...
  { id: '13696443-a295-4019-802b-d504e9d3c2ac', nome: '[OFF] SC_Video_Cinematic_01',     categoria: 'video',    perfil: ['alto_padrao', 'lancamento'],                                  formato: 'horizontal-16x9',      family: 'creatomate-stock', variant: 'cinematic',  objective: 'property_showcase',  placement: ['youtube', 'site'], active: false, legacyCategory: 'legacy' },
  { id: '7ab695ae-e12b-4322-87dc-eb085760dd01', nome: '[OFF] Real Estate Banner',        categoria: 'banner',   perfil: ['todos'],                                                      formato: 'banner-quadrado',      family: 'creatomate-stock', variant: 'generic',    objective: 'lead_generation',    placement: ['instagram_feed', 'facebook_feed', 'portal'], active: false, legacyCategory: 'legacy' },
  { id: 'b0438295-5282-4a5e-b4eb-4fcd3d8d287b', nome: '[OFF] Real Estate Card',          categoria: 'card',     perfil: ['todos'],                                                      formato: 'card-quadrado',        family: 'creatomate-stock', variant: 'generic',    objective: 'lead_generation',    placement: ['instagram_feed', 'facebook_feed'], active: false, legacyCategory: 'legacy' },
  { id: 'f6054e9d-0d28-40b2-81a9-21d291a9897b', nome: '[OFF] Real Estate Detailed',      categoria: 'detailed', perfil: ['todos'],                                                      formato: 'detalhado-quadrado',   family: 'creatomate-stock', variant: 'detailed',   objective: 'property_showcase',  placement: ['portal', 'instagram_feed', 'facebook_feed'], active: false, legacyCategory: 'legacy' },
  { id: 'c5338ec4-1f93-476a-a81c-ff0e7f2e91cf', nome: '[OFF] Real Estate Video Montage', categoria: 'video',    perfil: ['todos'],                                                      formato: 'video-horizontal',     family: 'creatomate-stock', variant: 'montage',    objective: 'property_showcase',  placement: ['youtube', 'site'], active: false, legacyCategory: 'legacy' },
  { id: '96a25196-5a64-4f65-9b3e-c9c8b0d871f2', nome: '[OFF] Triple Slide Carousel',     categoria: 'carousel', perfil: ['todos'],                                                      formato: 'carrossel-quadrado',   family: 'creatomate-stock', variant: 'carousel',   objective: 'property_showcase',  placement: ['instagram_feed', 'facebook_feed'], active: false, legacyCategory: 'legacy' },
  { id: 'ad9f8382-ea38-4ef6-84cc-049f1b289345', nome: '[OFF] New Listing Story',         categoria: 'story',    perfil: ['lancamento', 'em_construcao'],                                formato: 'vertical-9x16',        family: 'creatomate-stock', variant: 'new_listing', objective: 'new_listing',        placement: ['instagram_story', 'whatsapp_status'], active: false, legacyCategory: 'legacy' },
  { id: '7fc36174-64a6-4dbb-bb92-bb957471577e', nome: '[OFF] Photo Montage',             categoria: 'video',    perfil: ['todos'],                                                      formato: 'video-quadrado',       family: 'creatomate-stock', variant: 'montage',    objective: 'property_showcase',  placement: ['instagram_feed', 'facebook_feed'], active: false, legacyCategory: 'legacy' },
  { id: '792ad84a-0ab8-4e6c-bda1-400fe9c040cc', nome: '[OFF] Animated Review',           categoria: 'social',   perfil: ['todos'],                                                      formato: 'vertical-9x16',        family: 'creatomate-stock', variant: 'review',     objective: 'social_engagement',  placement: ['instagram_story', 'reels', 'whatsapp_status'], active: false, legacyCategory: 'legacy' },
  { id: 'a03e7b27-0747-497c-ae84-5b048fa31915', nome: '[OFF] Searchlight Reveal',        categoria: 'social',   perfil: ['todos'],                                                      formato: 'criativo-vertical',    family: 'creatomate-stock', variant: 'creative',   objective: 'social_engagement',  placement: ['instagram_story', 'reels', 'whatsapp_status'], active: false, legacyCategory: 'legacy' },
  { id: '57c55de1-e116-4cad-8470-54c68f023f6b', nome: '[OFF] Image Slideshow',           categoria: 'video',    perfil: ['todos'],                                                      formato: 'slideshow-horizontal', family: 'creatomate-stock', variant: 'slideshow',  objective: 'property_showcase',  placement: ['youtube', 'site'], active: false, legacyCategory: 'legacy' },
  { id: 'ba3afcf4-01cc-48e3-919a-8bc6d2dd4ca4', nome: '[OFF] Video Compilation',         categoria: 'video',    perfil: ['todos'],                                                      formato: 'video-horizontal',     family: 'creatomate-stock', variant: 'generic',    objective: 'property_showcase',  placement: ['youtube', 'site'], active: false, legacyCategory: 'legacy' },
]
